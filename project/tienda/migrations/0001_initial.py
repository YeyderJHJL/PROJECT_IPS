...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EstadoPersonal',
            fields=[
                ('estpercod', models.CharField(max_length=10, primary_key=True, serialize=False)),
                ('estpernom', models.CharField(max_length=50)),
                ('estperestreg', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estados_personal', to='tienda.estadoregistro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pronom', models.CharField(db_column='ProNom', max_length=60, unique=True)),
                ('prodes', models.CharField(blank=True, db_column='ProDes', max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sernom', models.CharField(db_column='SerNom', max_length=45, unique=True)),
                ('serdes', models.CharField(blank=True, db_column='SerDes', max_length=45, null=True)),
                ('serreqpre', models.CharField(blank=True, db_column='SerReqPre', max_length=45, null=True)),
                ('serdur', models.CharField(blank=True, db_column='SerDur', max_length=45, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conres', models.CharField(blank=True, db_column='ConRes', max_length=300, null=True)),
