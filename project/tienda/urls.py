...
urlpatterns = [
    ...
    #path('productos/modificar/<int:procod>/', views.modificar_producto, name='modificar_producto'),
    #path('productos/eliminar/<int:procod>/', views.eliminar_producto, name='eliminar_producto'),
